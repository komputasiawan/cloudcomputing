...
<head>
  ...
  <link rel="icon" href="img/mobil-1.png">
      ...
      <div class="container">
        <nav class="navbar">
          <div class="navbar-header">
            ...
            <h3 style="color: white;">|| RENTAL MOBIL</h3>
          </div>
          <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav pull-right">
              <li><a href="#" style="color: white;">HOME</a></li>
              <li><a href="viewuser.php" style="color: white;">SEWA MOBIL</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 header__content">
            ...
            <a class="header__button" href="viewuser.php">DISCOVER</a>
          </div>
        </div>
      </div>
    </header>
